...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="./smplx_322", help="the directory that stores the downloaded data.")
    parser.add_argument("--dataset_list", nargs='+')

    opt = parser.parse_args()


    motion_folder = opt.data_dir
    # dataset_list = ['humanml', "GRAB", 'EgoBody']
    dataset_list = opt.dataset_list

    for mocap_dataset in dataset_list:
...
# python face_motion_augmentation.py --data_dir "D:\\jarondu\\Datasets\\motion_X_two\\smplx_322" --dataset_list humanml "GRAB" "humanml" "EgoBody"